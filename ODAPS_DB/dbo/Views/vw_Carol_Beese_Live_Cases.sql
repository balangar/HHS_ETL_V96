CREATE VIEW dbo.vw_Carol_Beese_Live_Cases
AS
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_Carol_Beese_Live_Cases';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'le = 1170
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_Carol_Beese_Live_Cases';
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         Column = 1440
         Alias = 900
         Tab', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_Carol_Beese_Live_Cases';
