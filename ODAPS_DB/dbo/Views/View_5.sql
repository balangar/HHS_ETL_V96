...
AS
SELECT        sw.Name, sup.Name AS sup, Staging.Cases.Name AS encnum, Staging.Cases.ID, Staging.Contacts.Name AS client, ReportingParty.Name AS referent, Staging.Cases.Owner_County__c
...
WHERE        (Staging.Cases.Owner_County__c = 'Cuyahoga')
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_5';
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[32] 4[43] 2[7] 3) )"
      End
